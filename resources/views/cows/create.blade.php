...
<div class="contianer-fluid">
                        <div class="col-md-6 offset-3">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Good Quality Cows Forms</h3></div>
                                    <div class="card-body">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        {!! Form::number('serial_coedeve','',['class'=>'form-control','id'=>'serial_coedeve', 'placeholder'=>'ক্রমিক']) !!}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-2 mb-md-0">
                                                        ...
                                                        {!! Form::date('cowTarik','',['class'=>'form-control','placeholder'=>'তারিখ']) !!}
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class=" mb-2 mb-md-0">
                                                        ...
                                                        {!! Form::text('farmers_name','',['class'=>'form-control','id'=>'farmers_name', 'placeholder'=>'মালিকেরনাম']) !!}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('fat_name','',['class'=>'form-control','id'=>'fat_name', 'placeholder'=>'পিতারনাম']) !!}
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('vill','',['class'=>'form-control','id'=>'vill', 'placeholder'=>'গ্রাম']) !!}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('mobile','',['class'=>'form-control','id'=>'mobile', 'placeholder'=>'মোবাইলনং']) !!}
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-6">
                                                    <div class="">
                                                        {!! Form::label('gat','জাত') !!}
                                                        {!! Form::text('gat','',['class'=>'form-control','id'=>'gat', 'placeholder'=>'জাত']) !!}
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('old_cow','',['class'=>'form-control','id'=>'old_cow', 'placeholder'=>'বয়স']) !!}
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('color_ofbody','',['class'=>'form-control','id'=>'color_ofbody', 'placeholder'=>'Color']) !!}
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('num_culf','',['class'=>'form-control','id'=>'num_culf', 'placeholder'=>'বাচ্চার সংখ্যা']) !!}
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('amount_milk','',['class'=>'form-control','id'=>'amount_milk', 'placeholder'=>'দৈনিক দুধের পরিমাণ']) !!}
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('period_milk','',['class'=>'form-control','id'=>'period_milk', 'placeholder'=>'দুধ দেয়ারসময়কাল']) !!}
                                                ...
                                                <div class="col-md-12">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('total_milk','',['class'=>'form-control','id'=>'total_milk', 'placeholder'=>'মোট দুধের পরিমাণ']) !!}
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-12">
                                                    <div class="">
                                                        ...
                                                        {!! Form::text('remark','',['class'=>'form-control','id'=>'remark', 'placeholder'=>'মন্তব্য']) !!}
                                                    </div>
                                                </div>
