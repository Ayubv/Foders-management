<form action="{{url('cows/delete/'.$showcow->id)}}" method="post">
    @csrf
    
      <div class="modal fade" id="ModalDelete{{$showcow->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
